<%@ Page Title="" Language="C#" MasterPageFile="~/Risk.Master" AutoEventWireup="true" CodeBehind="MaintainUser.aspx.cs" Inherits="RiskProfilingApp.MaintainUser" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <h3 class="page-header"><i class="fa fa-file-text-o"></i>Maintain User</h3>
                <ol class="breadcrumb">
                    <li><i class="fa fa-home"></i><a href="Dashboard.aspx">Home</a></li>
                    <li><i class="icon_document_alt"></i><a href="#">Settings</a></li>
                    <li><i class="fa fa-file-text-o"></i>Maintain User</li>
                </ol>
            </div>
        </div>
        ...
        <table class="table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <asp:Label ID="unit" runat="server" Font-Bold="false" Font-Size="12pt">Change Role</asp:Label>
                    </td>
                    <td>
