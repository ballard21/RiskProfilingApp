<%@ Page Title="" Language="C#" MasterPageFile="~/Risk.Master" AutoEventWireup="true" CodeBehind="Countries.aspx.cs" Inherits="RiskProfilingApp.Countries" %>
        ...
        function PopulateDataTable(data) {
            ...
            $('#gridTable tbody').on('click', 'input', function () {
                ...
                if (buttonSelected == "Action") {
                    ...
                    // console.log(data);
                    window.location = "MaintainParams.aspx?Account=" + data[1];
                }
            });
